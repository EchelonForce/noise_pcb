...
# input_name = "alpha_pot_bob_panelized"
# output_name = "alpha_pot_bob_panelized"

# rename(folder, input_name, output_name)

folder = r'.\panelized_outputs'
input_name = "noise_pcb_panelized"
output_name = "noise_pcb_panelized"
